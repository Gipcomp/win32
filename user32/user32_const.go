...
const (
	HWND_BROADCAST = handle.HWND(0xFFFF)
	HWND_BOTTOM    = handle.HWND(1)
	HWND_NOTOPMOST = ^handle.HWND(1) // -2
	HWND_TOP       = handle.HWND(0)
	HWND_TOPMOST   = ^handle.HWND(0) // -1
	HWND_DESKTOP   = handle.HWND(0)
	HWND_MESSAGE   = ^handle.HWND(2) // -3
)
