...
const (
	NIN_SELECT           = user32.WM_USER + 0
	NIN_KEYSELECT        = user32.WM_USER + 1
	NIN_BALLOONSHOW      = user32.WM_USER + 2
	NIN_BALLOONHIDE      = user32.WM_USER + 3
	NIN_BALLOONTIMEOUT   = user32.WM_USER + 4
	NIN_BALLOONUSERCLICK = user32.WM_USER + 5
	NIN_POPUPOPEN        = user32.WM_USER + 6
	NIN_POPUPCLOSE       = user32.WM_USER + 7
)
