...
func (obj *IAccPropServices) SetHmenuProp(hmenu winuser.HMENU, idChild uint32, idProp *MSAAPROPID, v *VARIANT) HRESULT {
	propA, propB := idProp.split()
...
func (obj *IAccPropServices) SetHmenuPropStr(hmenu winuser.HMENU, idChild uint32, idProp *MSAAPROPID, str string) HRESULT {
	str16, err := syscall.UTF16PtrFromString(str)
	if err != nil {
		return -((E_INVALIDARG ^ 0xFFFFFFFF) + 1)
	}
